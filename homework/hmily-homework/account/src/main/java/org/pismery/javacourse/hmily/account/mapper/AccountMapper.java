...
public interface AccountMapper {
     ...
     */
    @Update("update `hmily_dubbo_account` " +
            "set us_wallet = us_wallet + #{usWallet}, cny_wallet = cny_wallet + #{cnyWallet} " +
            "where us_wallet >= #{usWallet} and cny_wallet >= #{cnyWallet} and id = #{id}")
